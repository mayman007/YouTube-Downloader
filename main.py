...
def DownlaodWindow():
    ...
    try: raw_data = urllib.request.urlopen(f"https://img.youtube.com/vi/{url.video_id}/maxresdefault.jpg").read()
    except: raw_data = urllib.request.urlopen("https://img.youtube.com/vi/dmg36v0zYbM/maxresdefault.jpg").read()
    ...
    def download_thumbnail():
        try:
            try:
                ...
                response = requests.get(f"https://img.youtube.com/vi/dmg36v0zYbM/maxresdefault.jpg")
                response.raise_for_status()
...
def SearchWindow():
    ...
    def results():
        ...
        # Get thumbnails
        try:
            try: raw_data = urllib.request.urlopen(f"https://img.youtube.com/vi/{url1.video_id}/maxresdefault.jpg").read()
            except: raw_data = urllib.request.urlopen("https://img.youtube.com/vi/dmg36v0zYbM/maxresdefault.jpg").read()
            ...
            try: raw_data = urllib.request.urlopen(f"https://img.youtube.com/vi/{url2.video_id}/maxresdefault.jpg").read()
            except: raw_data = urllib.request.urlopen("https://img.youtube.com/vi/dmg36v0zYbM/maxresdefault.jpg").read()
            ...
            try: raw_data = urllib.request.urlopen(f"https://img.youtube.com/vi/{url3.video_id}/maxresdefault.jpg").read()
            except: raw_data = urllib.request.urlopen("https://img.youtube.com/vi/dmg36v0zYbM/maxresdefault.jpg").read()
            ...
            try: raw_data = urllib.request.urlopen(f"https://img.youtube.com/vi/{url4.video_id}/maxresdefault.jpg").read()
            except: raw_data = urllib.request.urlopen("https://img.youtube.com/vi/dmg36v0zYbM/maxresdefault.jpg").read()
